...
var Search = /*#__PURE__*/function (_Component) {
  ...
  function Search() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function () {
      _this.props.searchArtist(_this.state.artisQuery);
    });
...
var Tracks = /*#__PURE__*/function (_Component) {
  ...
  function Tracks() {
      ...
      return function () {
        ...
        if (!_this.state.playing) {
          ...
          _this.setState({
            playing: true,
            audio: audio,
            playingStatus: previewUrl
          });
        } else {
          _this.state.audio.pause();

          if (_this.state.playingStatus === previewUrl) {
            _this.setState({
              playing: false
            });
          } else {
    ...
    _defineProperty(_assertThisInitialized(_this), "trackIcon", function (track) {
      ...
      if (_this.state.playing == true && _this.state.playingStatus == track.preview_url) {
...
var App = /*#__PURE__*/function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h2", null, "Music App"), /*#__PURE__*/_react.default.createElement(_Search.default, {
